          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              <View style={styles.item}>
                ...
                <TouchableOpacity style = {{marginTop:6,backgroundColor: '#FD001B',borderRadius:4,width: 120}} onPress={this._onPressButton}>
                <Text style= {{textAlign: 'center',marginLeft:10,marginRight:10,color: 'white',marginTop:5,marginBottom:5}}>Rejected</Text>
                </TouchableOpacity>
                }
